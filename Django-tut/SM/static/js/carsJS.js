...
{
  var spotLat = document.getElementById("endLat").value;
  var spotLong = document.getElementById("endLong").value;
  ...
  var spot = {
   ...
   $.ajax({
                            ...
                            success: function(result){
                               console.log("The spot is deleted successfully");
                        }
...
function calcRoute() {
  ...
  directionsService.route(request, function(response, status) {
    if (status == google.maps.DirectionsStatus.OK) {
      ...
      //map.setZoom(18);
      startAnimation() ;
      setTimeout(function(){initMap()},10000);
...
function animate(d) {
  ...
  setTimeout(function(){animate((d + step));resolve("Stuff worked")}, tick);
}
